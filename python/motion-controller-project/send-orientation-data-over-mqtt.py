...
import DeviceOrientationData as orientationData
...
while True:
    ...
    # Get sensor data
    data = orientationData.getData(sense, uuidDevice, dateTime)
    ...
    # Send over MQTT
    client.loop_start()
    client.publish("encyclopedia/orientation", payload=dataJson, qos=2)
    client.loop_stop()
