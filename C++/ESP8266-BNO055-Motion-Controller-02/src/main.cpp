...
void loop() {
  ...
  String ox = String( orientationData.orientation.x);
  String oy = String( orientationData.orientation.y);
  String oz = String(-orientationData.orientation.z);

  String ax = String( linearAccelData.acceleration.x);
  String ay = String( linearAccelData.acceleration.y);
  String az = String( linearAccelData.acceleration.z);

  // Convert the orientation data to a JSON string
  String message = oy + ", " + ox + ", " + oz + ", " + ax + ", " + ay + ", " + az;
